  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.7)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
      <div style={{ background: '#09090f', border: '1px solid rgba(255,255,255,0.06)', borderRadius: '16px', padding: '32px', width: '90%', maxWidth: '600px', maxHeight: '90vh', overflowY: 'auto', position: 'relative', fontFamily: "'DM Sans', sans-serif" }}>
        ...
        <h2 style={{ fontFamily: "'Noto Serif', serif", color: '#E8E6F0', marginTop: 0 }}>🎯 Optimize for Job Description</h2>
        
        {!suggestions ? (
          <>
            <p style={{ color: 'rgba(255,255,255,0.4)', marginBottom: '16px' }}>Paste the Job Description below to get AI-powered optimization suggestions.</p>
            <textarea 
              value={jd} 
          ...
          <div>
            ...
            <h4 style={{ color: '#E8E6F0', marginBottom: '8px' }}>Suggested Bullet Improvements</h4>
