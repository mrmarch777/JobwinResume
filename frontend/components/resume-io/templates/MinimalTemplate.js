...
export default function MinimalTemplate({ resume }) {
  ...
  const styles = {
    ...
    sectionTitle: { pageBreakAfter: 'avoid', breakAfter: 'avoid', fontSize: fSize.heading, fontWeight: '400', color: '#111111', textTransform: 'uppercase', letterSpacing: '1px', marginBottom: spc.item },
