...
export default function IndustrialTemplate({ resume }) {
  ...
  const styles = {
    ...
    sectionTitle: { pageBreakAfter: 'avoid', breakAfter: 'avoid', fontSize: fSize.heading, fontWeight: 'bold', color: '#000000', textTransform: 'uppercase', borderBottom: '2px dashed #999', paddingBottom: '4px', marginBottom: spc.item, letterSpacing: '1px' },
