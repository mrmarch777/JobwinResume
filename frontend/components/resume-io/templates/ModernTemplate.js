...
export default function ModernTemplate({ resume }) {
  ...
  const styles = {
    ...
    mainTitle: { fontSize: fSize.heading, fontWeight: 'bold', textTransform: 'uppercase', color: accentColor, marginBottom: spc.item, borderBottom: '2px solid #EEEEEE', paddingBottom: '4px', pageBreakAfter: 'avoid', breakAfter: 'avoid' },
    ...
    itemHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', pageBreakInside: 'avoid', breakInside: 'avoid', pageBreakAfter: 'avoid', breakAfter: 'avoid' },
    itemTitle: { fontWeight: 'bold', color: '#000000' },
    itemSubtitle: { color: '#555555', fontStyle: 'italic', pageBreakBefore: 'avoid', breakBefore: 'avoid' },
