...
export default function TwoColumnTemplate({ resume }) {
  ...
  const styles = {
    ...
    header: { padding: '40px 45px 20px 45px', textAlign: 'left', borderBottom: `4px solid ${accentColor}` },
    ...
    columnsContainer: { display: 'flex', flex: 1, padding: '0 45px 40px 45px' },
    ...
    sectionTitle: { pageBreakAfter: 'avoid', breakAfter: 'avoid', fontSize: fSize.heading, fontWeight: 'bold', color: accentColor, textTransform: 'uppercase', marginBottom: spc.item, letterSpacing: '1px' },
